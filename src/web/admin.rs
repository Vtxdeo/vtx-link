...
/// 手动启动流 API
/// 启动指定名称的流，并返回操作结果信息
pub async fn handle_start(State(state): State<SharedState>, Path(name): Path<String>) -> String {
...
/// 手动停止流 API
/// 停止指定名称的流，并返回操作结果信息
pub async fn handle_stop(State(state): State<SharedState>, Path(name): Path<String>) -> String {
